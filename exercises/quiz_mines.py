...
options=[
    ...
    score=6,
        ...
        QuizQuestion(question="Dans un module d'intégration Verilog, lorsqu'on veut relier la sortie d'un module sur l'entrée d'un autre, on peut utiliser :",
options=[
    ...
    score=6,
        ...
        QuizQuestion(question=TextContent("""// clk est une entrée d'horloge
reg[1:0] a ;
reg[1:0] b ;
